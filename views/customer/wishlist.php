    ...
    <aside style="width: 250px; background: #fff; border-right: 2px solid #eee; flex-shrink: 0;">
        ...
        <nav style="padding: 20px;">
            <ul style="list-style: none; padding: 0; margin: 0;">
                ...
                <li style="margin-bottom: 10px;">
                    <a href="<?= BASE_URL ?>/customer/wishlist" style="display: block; padding: 12px 15px; border-radius: 8px; background: #0d9488; color: #fff; text-decoration: none; font-weight: 700;">
    ...
    <main style="flex: 1; padding: 50px; background: #fafafa;">
        <div style="max-width: 900px; margin: 0 auto;">
            <div style="margin-bottom: 40px;">
                <h1 style="font-size: 2.2rem; color: #111; margin-bottom: 10px; font-weight: 800;">My Favorites</h1>
                <p style="color: #666; font-size: 1.1rem;">A list of all the products you've saved to buy later.</p>
            </div>
