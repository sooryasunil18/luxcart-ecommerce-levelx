    ...
    <aside style="width: 250px; background: #fff; border-right: 1px solid #e5e7eb; flex-shrink: 0;">
        ...
        <nav style="padding: 20px;">
            <ul style="list-style: none; padding: 0; margin: 0;">
                ...
                <li style="margin-bottom: 10px;">
                    <a href="<?= BASE_URL ?>/customer/orders" style="display: block; padding: 12px 15px; border-radius: 8px; background: #0d9488; color: #fff; text-decoration: none; font-weight: 700; font-size: 1rem;">
    ...
    <main style="flex: 1; padding: 50px; background: #fafafa;">
        <div style="max-width: 900px; margin: 0 auto;">
            <div style="margin-bottom: 40px;">
                <h1 style="font-size: 1.5rem; color: #1a1a2e; margin-bottom: 10px; font-weight: 800;">My Orders</h1>
                <p style="color: #4b5563; font-size: 1rem;">Here you can see everything you've bought from us.</p>
            </div>
                            ...
                            <div style="padding: 20px 35px;">
                                <?php foreach ($order['items'] as $item): ?>
                                    <div style="display: flex; gap: 30px; padding: 25px 0; border-bottom: 1px solid #f5f5f5; align-items: center;">
                                        ...
                                        <!-- Simple Action -->
                                        <div>
                                            <a href="<?= BASE_URL ?>/product/<?= $item['slug'] ?>" class="btn btn-primary" style="background: #0d9488; padding: 10px 20px; border-radius: 50px; font-weight: 700; font-size: 0.95rem;">Buy Again</a>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
